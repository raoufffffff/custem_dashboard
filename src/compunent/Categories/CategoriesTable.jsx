...
const CategoriesTable = ({ Categories, repoName, handleUpdateCategory }) => {
            ...
            >
                ...
                >
                    ...
                    <button
                        onClick={() => {
                            hide()
                            handleUpdateCategory(newCategories.filter(e => e.id != show.id), repoName)
                        }}
                                ...
                                >
                                    ...
                                    <td className="px-4">
                                        <div className="flex gap-3">
                                            ...
                                            <Trash2
                                                onClick={() => setShow({ show: false, id: p.id, showDelete: true, name: p.name })}
